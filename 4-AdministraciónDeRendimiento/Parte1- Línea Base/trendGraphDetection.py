...
def grafica ():
    rrdpath = '/home/eric/ASR/Practicas/Problema1_2/4-AdministraciónDeRendimiento/RRD/'
    imgpath = '/home/eric/ASR/Practicas/Problema1_2/4-AdministraciónDeRendimiento/IMG/'
    ...
    ret = rrdtool.grafica( imgpath+imgName,
                        "--start",str(tiempo_inicial),
                        "--end",str(tiempo_final),
                        "--vertical-label=Cpu load y prediccion",
                        '--lower-limit', '0',
                        '--upper-limit', '100',
